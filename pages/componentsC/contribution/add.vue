<template>
	<view class="bianjia u-demo-block__content">
		<u--form labelPosition="left" :model="model" ref="form1">
			...
			<u-form-item label="是否匿名:" borderBottom ref="item1" labelWidth="100" >
				<u-radio-group v-model="model.ni">
			...
			<u-form-item label="捐献金额:" borderBottom ref="item1" labelWidth="100">
				<u--input v-model="model.pay" border="none" placeholder="请输入捐献金额 如: 0.01" ></u--input>
			</u-form-item>
			
			<u-form-item label="捐款凭证:" borderBottom ref="item1" labelWidth="100">
			...
			<u-form-item label="备注信息:" borderBottom ref="item1" labelWidth="100">
				<u--textarea v-model="model.remarks" placeholder="请输入备注信息" ></u--textarea>
			</u-form-item>
			<!-- <u-form-item label="账户:"  borderBottom ref="item1" labelWidth="60">
				<u--text type="warning" text="开户行:******"></u--text>
				<u--text type="warning" text="姓名:**********"></u--text>
				<u--text type="warning" text="收款账号:*********************"></u--text>
			</u-form-item> -->
	...
	export default {
		...
		methods: {
			...
			tijiao() {
				...
				uni.$u.http.post('Contribution/edit', this.model)
					.then(res => {
						// this.list=res.data;
						// console.log(res)
